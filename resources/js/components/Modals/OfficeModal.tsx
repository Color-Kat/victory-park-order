...
export const OfficeModal: React.FC = () => {
    ...
    return (
        <div
            className={`${officeModalOfficeId ? 'opacity-1 translate-y-0 shadow-2xl' : 'opacity-0 -translate-y-8 pointer-events-none'} fixed w-screen h-screen px-2 pt-6 pb-16 top-0 left-0 bg-black/[.7] flex items-center justify-center z-40 transition duration-300`}
        >
            <div
