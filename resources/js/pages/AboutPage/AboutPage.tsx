    ...
    return (
        <div className="w-full flex flex-col text-center text-[#3b4256]">
            ...
            <TextSection
                ...
                text='Главными преимуществами для арендаторов являются развитая внешняя и внутренняя инфраструктура, подземная парковка, а так же прекрасная транспортная доступность. Недалеко Бульварное кольцо, Кутузовский проспект и ТТК.'
            />
