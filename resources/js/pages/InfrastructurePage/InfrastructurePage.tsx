        ...
        <div className="w-full flex flex-col text-center text-[#3b4256]">
            ...
            <section className="md:px-8 px-5">
                <p className="max-w-3xl mx-auto sm:my-12 my-8">
                    Бизнес-центр Павелецкая Плаза в Москве предлагает своим арендаторам развитую и современную инфраструктуру, созданную для обеспечения комфортного и продуктивного рабочего окружения. Вот некоторые из основных элементов инфраструктуры, доступных в бизнес-центре Павелецкая Плаза:

                    <ul className="pt-2">
                        <li>1. Рестораны и кафе</li>
                        <li>2. Банк и банкоматы</li>
                        <li>3. Конференц-залы и переговорные комнаты</li>
                        <li>4. Фитнес-центр</li>
                        <li>5. Парковка и транспортные услуги</li>
                    </ul>
                </p>
            </section>
            ...
            <section className="md:px-8 px-5 text-base mb-16">
                ...
                <div className="partner-logos flex items-center sm:my-16 my-8 gap-3 justify-between flex-wrap max-w-5xl mx-auto sm:flex-row flex-col">
                    <img src={partner_logo_1} alt=""/>
                    <img src={partner_logo_2} alt=""/>
                    <img src={partner_logo_3} alt=""/>
                    <img src={partner_logo_4} alt=""/>
                </div>
            </section>
