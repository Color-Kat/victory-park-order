    ...
    return (
        <div className="w-full flex flex-col text-center text-[#3b4256]">
            ...
            <Helmet>
                ...
                <meta name="description" content={`В инфраструктуру Лотте Плаза также входит универсальный торговый центр в 8 этажей, рассчитанный на разные категории потребителей.`} />
            ...
            <section className="md:px-8 px-5">
                <p className="max-w-3xl mx-auto sm:my-12 my-8">
                    В инфраструктуру Лотте Плаза также входит универсальный торговый центр в 8 этажей, рассчитанный на разные категории потребителей. Здесь представлены многочисленные бутики класса люкс, известные демократичные бренды, а также впервые вышедшие на российский рынок корейские марки. В комплексе представлены ресторан Zafferano, ресторан итальянской пасты Pasta-House Vesuvio, ресторан фьюжн-кухни «Балкон». Среди кафе - Movenpick, японская закусочная YOBI и Express Cafe. Кроме того, в торговом центре расположились Аптека 36,6, супермаркет «Азбука Вкуса», компьютерный магазин re:Store, книжный «Республика», центр восточной медицины Amrita, интернет-кафе Internet-lounge Библitека, салоны красоты Naioli beauty lounge Alter Ego и Power Plate Studio. На крыше Лотте Плаза расположен ресторан Калина Бар с роскошным видом на Москву.
                </p>
            </section>
